      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="mode-card group">
          ...
          <div className="mt-auto">
            <p>
              <span className="text-[#60a5fa] font-medium">Time:</span> 1-2
              minutes
            </p>
            <p>
              <span className="text-[#60a5fa] font-medium">Accuracy:</span>{" "}
              80-85%
            </p>
          </div>
          <div className="mt-6">
            <button onClick={() => onSelect("quick")} className="st-button">
        ...
        <div className="mode-card group">
          ...
          <div className="mt-auto">
            <p>
              <span className="text-[#60a5fa] font-medium">Time:</span> 3-5
              minutes
            </p>
            <p>
              <span className="text-[#60a5fa] font-medium">Accuracy:</span>{" "}
          ...
          <div className="mt-6">
            <button onClick={() => onSelect("detailed")} className="st-button">
