            ...
            {[
              ...
              >
                <div className="flex flex-col gap-1">
                  <span
                    className={`text-sm font-medium ${frequency === opt.val ? "text-blue-300" : "text-slate-200"}`}
                  >
                    {opt.label}
                  </span>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {durationOptions.map((opt) => (
              ...
              >
                <div className="flex flex-col gap-1">
                  <span
                    className={`text-sm font-medium ${duration === opt.val ? "text-blue-300" : "text-slate-200"}`}
                  >
                    {opt.label.split(" ")[0]} {/* e.g. "15" */}
                  </span>
                  <span
                    className={`text-xs ${duration === opt.val ? "text-blue-200/70" : "text-slate-500"}`}
                  >
                    minutes
                  </span>
                </div>
