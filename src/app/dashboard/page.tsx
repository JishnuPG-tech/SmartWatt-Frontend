...
const ApplianceBarChart = dynamic(
  () => import("@/components/dashboard/ApplianceBarChart"),
  {
    ssr: false,
    loading: () => (
      <Skeleton className="h-[350px] w-full rounded-2xl bg-slate-800/50" />
  ...
  const handleHistoryDelete = async (entryToDelete: any) => {
    ...
    try {
      ...
      const updatedHistory = currentHistory.filter(
        (h: any) => h.date !== entryToDelete.date,
      );
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="text-center max-w-md">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-8">
              You have no saved history. Run your first SmartWatt energy
              assessment to see your personalised KSEB bill breakdown and
