...
export const USAGE_FORMS: Record<string, ApplianceFormConfig> = {
  ...
  refrigerator: {
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          { value: "unknown", label: "Don't Know" },
          { value: "direct", label: "Direct Cool" },
          { value: "frost", label: "Frost Free" },
        ],
      },
      {
        label: "Age",
  ...
  washing_machine: {
    ...
    patterns: [
      ...
      {
        value: "moderate",
        label: "Moderate (3-4 cycles/week) - Regular household",
      },
      { value: "heavy", label: "Heavy (5-6 cycles/week) - Large family" },
      {
        value: "very_heavy",
        label: "Very Heavy (7+ cycles/week) - Daily washing",
      },
    ],
    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: "top_load", label: "Top Load (Fully Automatic)" },
          { value: "front_load", label: "Front Load (Fully Automatic)" },
        ],
      },
      {
        label: "Capacity",
        ...
        options: [
          ...
          { value: "7.0", label: "7.0 kg" },
          { value: "8.0", label: "8.0 kg+" },
        ],
      },
      {
        label: "Star Rating",
  ...
  geyser: {
    ...
    patterns: [
      ...
      {
        value: "moderate",
        label: "Moderate (2-3 hours/day) - Morning + evening",
      },
      {
        value: "heavy",
        label: "Heavy (3+ hours/day) - Frequent hot water use",
      },
    ],
    ...
    fields: [
      {
        ...
        options: [
          { value: "unknown", label: "Don't Know" },
          { value: "instant", label: "Instant (3kW+)" },
          { value: "storage", label: "Storage (2kW)" },
          { value: "gas", label: "Gas Geyser" },
        ],
      },
      {
        label: "Capacity",
        ...
        options: [
          { value: "unknown", label: "Don't Know" },
          { value: "3L", label: "3 Liters (Instant)" },
    ...
    fields: [
      {
        ...
        options: [
          { value: "unknown", label: "Don't Know" },
          { value: "standard", label: "Standard (Old, ~75W)" },
          { value: "bldc", label: "BLDC (Energy Saver, ~30W)" },
        ],
      },
      {
        ...
        options: [
          { value: "1", label: "1 fan" },
          { value: "2", label: "2 fans" },
          { value: "3", label: "3 fans" },
          { value: "4", label: "4-5 fans" },
          { value: "6", label: "6+ fans" },
        ],
      },
    ],
  },
    ...
    fields: [
      {
        ...
        options: [
          { value: "unknown", label: "Don't Know" },
          { value: "LED", label: "LED / LCD" },
          { value: "CRT", label: "Old Box TV (CRT)" },
